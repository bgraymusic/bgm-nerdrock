...
BG.Badges.generateURL = 'https://5pkvlh4fm5.execute-api.us-east-1.amazonaws.com/dev/api/badges';
BG.Badges.validateURL = 'https://5pkvlh4fm5.execute-api.us-east-1.amazonaws.com/dev/api/badges/{token}';
BG.Badges.addURL = 'https://5pkvlh4fm5.execute-api.us-east-1.amazonaws.com/dev/api/badges/{token}/{key}';
...
BG.Badges.prototype = {
	...
	generateNewToken: function() {
		fetch(BG.Badges.generateURL)
			.then(response => console.log(response))
			.catch(error => console.log(error));
	},

	validateToken: function(token) {
		fetch(BG.Badges.validateURL.replace('{token}', token))
			.then(response => console.log(response))	
			.catch(error => console.log(error));
	},
